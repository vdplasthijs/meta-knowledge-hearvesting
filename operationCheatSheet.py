...
async def extract_entities(
    ...
    fill_nightly_prompt = PROMPTS["entity_fill_nightly_extraction"]
    ...
    async def _nightly_inference_on_initial_result(
        ...
        for entity_name, entity_info_dict in maybe_nodes.items():
            ...
            for neighbor in neighbors:
                ...
                nightly_edges[(entity_name, "Nightly Entity Name")].append(
                    dict(
                        ...
                        description=nightly_edge_data["description"],
    ...
    async def fill_nightly_nodes_edges_with_llm(
        ...
        ).format(**context_base, input_text=input_text)
    ...
    async def _process_single_content(chunk_key_dp: tuple[str, TextChunkSchema]):
        ...
        nightly_nodes, nightly_edges = await _nightly_inference_on_initial_result(
            maybe_nodes, maybe_edges, chunk_key, file_path
        )
